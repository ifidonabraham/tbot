...
MT5_SET_BROKER_STOP_LOSS = _bool("MT5_SET_BROKER_STOP_LOSS", True)
MT5_SET_BROKER_TAKE_PROFIT = _bool("MT5_SET_BROKER_TAKE_PROFIT", False)
...
LIVE_SPREAD_CHECK_ENABLED = _bool("LIVE_SPREAD_CHECK_ENABLED", True)
MAX_LIVE_SPREAD_PERCENT = _float("MAX_LIVE_SPREAD_PERCENT", _float("LAYER5_MAX_SPREAD_PERCENT", 0.05))
...
POSITION_CHECK_SECONDS = _float("POSITION_CHECK_SECONDS", 2.0)
ENTRY_SCAN_SECONDS = _float("ENTRY_SCAN_SECONDS", 10.0)
MICRO_PROFIT_EXIT_ENABLED = _bool("MICRO_PROFIT_EXIT_ENABLED", True)
MICRO_PROFIT_MIN_PERCENT = _float("MICRO_PROFIT_MIN_PERCENT", 0.05)
MICRO_PROFIT_MIN_MONEY = _float("MICRO_PROFIT_MIN_MONEY", 0.03)
MICRO_PROFIT_FADE_SCORE = _float("MICRO_PROFIT_FADE_SCORE", 55.0)
MICRO_PROFIT_LOCK_GIVEBACK_PERCENT = _float("MICRO_PROFIT_LOCK_GIVEBACK_PERCENT", 0.03)
MICRO_PROFIT_GIVEBACK_MONEY = _float("MICRO_PROFIT_GIVEBACK_MONEY", 0.01)
BREAKEVEN_TRIGGER_MONEY = _float("BREAKEVEN_TRIGGER_MONEY", 0.03)
STOP_LOSS_MONEY = _float("STOP_LOSS_MONEY", 0.08)
TAKE_PROFIT_MONEY = _float("TAKE_PROFIT_MONEY", 0.10)
TRAILING_ACTIVATION_MONEY = _float("TRAILING_ACTIVATION_MONEY", 0.10)
TRAILING_GIVEBACK_MONEY = _float("TRAILING_GIVEBACK_MONEY", 0.04)
EXTENDED_TAKE_PROFIT_MONEY = _float("EXTENDED_TAKE_PROFIT_MONEY", 0.18)
